...
// Добавляем псевдокласс hover
const hoverStyle = {
  backgroundColor: 'lightgray' // цвет фона при наведении
};

// Компонент с использованием стилей
          ...
          <StyledContainer>
            ...
            <Hero>
              ...
              {/* <button
                ...
                style={{ padding: '20px 20px', width: '150px', backgroundColor: 'white', color: 'black', fontSize: '18px', fontWeight: 'normal', borderRadius: '8px', outline: 'none', border: 'none' }}
              >MINT</button> */}
                <Mint />
            </Hero>
          </StyledContainer>
